	...
	extern unsigned int _Aufgabe_4_LoesungMachineNumber_;
	#define _SFD_SET_DATA_VALUE_PTR(v1,v2)\
		sf_debug_set_instance_data_value_ptr(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1,(void *)(v2),NULL);
	#define _SFD_UNSET_DATA_VALUE_PTR(v1)\
		sf_debug_unset_instance_data_value_ptr(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1);
	#define _SFD_SET_DATA_VALUE_PTR_VAR_DIM(v1,v2,v3)\
		sf_debug_set_instance_data_value_ptr(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1,(void *)(v2),(void *)(v3));
	#define _SFD_DATA_RANGE_CHECK_MIN_MAX(dVal,dNum,objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn,dMin,dMax,ssid,offset,length)\
	                      sf_debug_data_range_error_wrapper_min_max(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
 ...
 (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn,(double)dMin,(double)dMax,ssid,offset,length)
	#define _SFD_DATA_RANGE_CHECK_MIN(dVal,dNum,objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn,dMin,ssid,offset,length)\
	                      sf_debug_data_range_error_wrapper_min(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             dNum,(double)(dVal),\
 (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn,(double)dMin,ssid,offset,length)
	#define _SFD_DATA_RANGE_CHECK_MAX(dVal,dNum,objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn,dMax,ssid,offset,length)\
	                      sf_debug_data_range_error_wrapper_max(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             dNum,(double)(dVal),\
 (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn,(double)dMax,ssid,offset,length)
	#define _SFD_DATA_RANGE_CHECK(dVal,dNum,objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn)\
	                      sf_debug_data_range_wrapper(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             dNum,(double)(dVal),\
 (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn)
	#define _SFD_DATA_READ_BEFORE_WRITE_ERROR(dNum,objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn)\
	                      sf_debug_read_before_write_error(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (unsigned int)(dNum),\
 (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn)
	#define _SFD_ARRAY_BOUNDS_CHECK(v1,v2,v3,v4,v5,v6) \
	                      sf_debug_data_array_bounds_error_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(int)(v2),(int)(v3),(int)(v4),(int)(v5),(int)(v6))
	#define _SFD_RUNTIME_SIZE_MISMATCH_CHECK(v1,v2,v3,v4,v5) \
	                      sf_debug_data_runtime_size_mismatch_error_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(v2),(unsigned int)(v3),(int)(v4),(int)(v5))
	#define _SFD_EML_ARRAY_BOUNDS_CHECK(v1,v2,v3,v4,v5,v6) \
	                      sf_debug_eml_data_array_bounds_error_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(int)(v2),(int)(v3),(int)(v4),(int)(v5),(int)(v6))
	#ifdef INT_TYPE_64_IS_SUPPORTED
	#define _SFD_EML_ARRAY_BOUNDS_CHECK_INT64(v1,v2,v3,v4,v5,v6) \
	                      sf_debug_eml_data_array_bounds_error_check_int64(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(int64_T)(v2),(int)(v3),(int)(v4),(int)(v5),(int)(v6))
	#endif
	#define _SFD_INTEGER_CHECK(v1,v2) \
	                      sf_debug_integer_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(double)(v2))
	#define _SFD_NOT_NAN_CHECK(v1,v2) \
	                      sf_debug_not_nan_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(double)(v2))
	#define _SFD_NON_NEGATIVE_CHECK(v1,v2) \
	                      sf_debug_non_negative_check(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),(double)(v2))
	#define _SFD_CAST_TO_UINT8(v1) \
	                      sf_debug_cast_to_uint8_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_UINT16(v1) \
	                      sf_debug_cast_to_uint16_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_UINT32(v1) \
	                      sf_debug_cast_to_uint32_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_INT8(v1) \
	                      sf_debug_cast_to_int8_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_INT16(v1) \
	                      sf_debug_cast_to_int16_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_INT32(v1) \
	                      sf_debug_cast_to_int32_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_CAST_TO_SINGLE(v1) \
	                      sf_debug_cast_to_real32_T(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	                                             (v1),0,0)
	#define _SFD_ANIMATE() sf_debug_animate(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER)
	#define _SFD_CHART_CALL(v1,v2,v3,v4) sf_debug_call(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	CHART_OBJECT,v1,v2,v3,v4,\
	0,NULL,_sfTime_,1)
	#define _SFD_MESSAGE_POST_CALL(v1) sf_debug_register_message_post_receive_info(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	v1,_sfTime_,1)
	#define _SFD_MESSAGE_RECEIVE_CALL(v1) sf_debug_register_message_post_receive_info(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	v1,_sfTime_,0)
	...
	#define _SFD_EML_CALL(v1,v2,v3) eml_debug_line_call(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	v1,v2,\
	v3,_sfTime_,0)
	#define _SFD_SCRIPT_TRANSLATION(v1,v2,v3,v4) sf_debug_set_script_translation(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	v1,v2,v3,v4)
	#define _SFD_SCRIPT_CALL(v1,v2,v3) eml_debug_line_call(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	v1,v2,\
	v3,_sfTime_,1)
	#define _SFD_CCP_CALL(v3,v4,v5,v6) sf_debug_call(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	CHART_OBJECT,TRANSITION_OBJECT,TRANSITION_GUARD_COVERAGE_TAG,v3,v6,\
	v4,NULL,_sfTime_,(unsigned int)(v5))
	#define _SFD_STATE_TEMPORAL_THRESHOLD(v1,v2,v4) sf_debug_temporal_threshold(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	(unsigned int)(v1),(v2),STATE_OBJECT,(v4))
	#define _SFD_TRANS_TEMPORAL_THRESHOLD(v1,v2,v4) sf_debug_temporal_threshold(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	(unsigned int)(v1),(v2),TRANSITION_OBJECT,(v4))
	#define CV_EVAL(v1,v2,v3,v4) cv_eval_point(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4))
	#define CV_CHART_EVAL(v2,v3,v4) CV_EVAL(CHART_OBJECT,(v2),(v3),(v4))
	#define CV_STATE_EVAL(v2,v3,v4) CV_EVAL(STATE_OBJECT,(v2),(v3),(v4))
	#define CV_TRANSITION_EVAL(v1,v2) cv_eval_point(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  TRANSITION_OBJECT,(v1),0,((v2)!=0))
	#define CV_RELATIONAL_EVAL(v1,v2,v3,v4,v5,v6,v7,v8)  cv_eval_relational(sfGlobalDebugInstanceStruct,_Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8))
	#define CV_BASIC_BLOCK_EVAL(v1,v2,v3)  cv_eval_basic_block(sfGlobalDebugInstanceStruct,_Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3))
	#define CV_SATURATION_EVAL(v1,v2,v3,v4,v5)  cv_eval_saturation(sfGlobalDebugInstanceStruct,_Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4),(v5))
	#define CV_SATURATION_ACCUM(v1,v2,v3,v4)  cv_saturation_accum(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4))
	#define CV_TESTOBJECTIVE_EVAL(v1,v2,v3,v4)  cv_eval_testobjective(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4))
	
	/* Coverage Macros for MATLAB  */
	#define CV_EML_EVAL(v1,v2,v3,v4,v5) cv_eml_eval(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4),(int)(v5))
	...
	#define CV_SCRIPT_EVAL(v1,v2,v3,v4) cv_script_eval(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(int)(v4))
	...
	#define _SFD_SET_DATA_PROPS(dataNumber,dataScope,isInputData,isOutputData,dataName)\
	 sf_debug_set_chart_data_props(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
	...
	#define _SFD_SET_DATA_COMPILED_PROPS(dataNumber,dataType,numDims,dimArray,isFixedPoint,isSigned,wordLength,bias,slope,exponent,complexity,mexOutFcn, mexInFcn)\
	 sf_debug_set_chart_data_compiled_props(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,\
	...
	#define _SFD_STATE_INFO(v1,v2,v3)\
		sf_debug_set_chart_state_info(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1),(v2),(v3))
	#define _SFD_CH_SUBSTATE_INDEX(v1,v2)\
		sf_debug_set_chart_substate_index(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1),(v2))
	#define _SFD_ST_SUBSTATE_INDEX(v1,v2,v3)\
	   sf_debug_set_chart_state_substate_index(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1),(v2),(v3))
	#define _SFD_ST_SUBSTATE_COUNT(v1,v2)\
		sf_debug_set_chart_state_substate_count(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1),(v2))
	#define _SFD_DATA_CHANGE_EVENT_COUNT(v1,v2) \
		sf_debug_set_number_of_data_with_change_event_for_chart(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
		(v1),(v2))
	#define _SFD_STATE_ENTRY_EVENT_COUNT(v1,v2) \
		sf_debug_set_number_of_states_with_entry_event_for_chart(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
		(v1),(v2))
	#define _SFD_STATE_EXIT_EVENT_COUNT(v1,v2) \
		sf_debug_set_number_of_states_with_exit_event_for_chart(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
		(v1),(v2))
	#define _SFD_EVENT_SCOPE(v1,v2)\
		sf_debug_set_chart_event_scope(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		CHARTINSTANCE_CHARTNUMBER,(v1),(v2))
	
	#define _SFD_CH_SUBSTATE_COUNT(v1) \
		sf_debug_set_chart_substate_count(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1))
	#define _SFD_CH_SUBSTATE_DECOMP(v1) \
		sf_debug_set_chart_decomposition(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,(v1))
	
	#define _SFD_CV_INIT_CHART(v1,v2,v3,v4)\
	 sf_debug_cv_init_chart(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
		CHARTINSTANCE_INSTANCENUMBER,(v1),(v2),(v3),(v4))
	
	#define _SFD_CV_INIT_STATE(v1,v2,v3,v4,v5,v6,v7,v8)\
		sf_debug_cv_init_state(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,CHARTINSTANCE_CHARTNUMBER,\
		CHARTINSTANCE_INSTANCENUMBER,(v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8))
	
	#define _SFD_CV_INIT_TRANSITION_SATURATION(v1,v2,v3,v4)\
	     sf_debug_cv_init_saturation(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
		  TRANSITION_OBJECT,(v1),(v2),(v3),(v4))
	
	#define _SFD_CV_INIT_TRANSITION_RELATIONALOP(v1,v2,v3,v4,v5,v6)\
	     sf_debug_cv_init_relationalop(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
	...
	#define _SFD_CV_INIT_TRANSITION_TESTOBJECTIVE(v1,v2,v3,v4)\
	     sf_debug_cv_init_testobjectives(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
		  TRANSITION_OBJECT,(v1),(v2),(v3),(v4))
	...
	#define _SFD_CV_INIT_TRANS(v1,v2,v3,v4,v5,v6)\
	     sf_debug_cv_init_trans(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
		  (v1),(v2),(v3),(v4),(v5),(v6))
	#endif
	...
	#define _SFD_REPORT_STATE_INCONSISTENCY_ERROR(objectTypeEnum,objectNumber,activeEventNumber,isFasterRuntimeOn) \
         sf_debug_report_state_inconsistency_error(sfGlobalDebugInstanceStruct, _Aufgabe_4_LoesungMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
                                                (unsigned int)objectTypeEnum,(unsigned int)objectNumber,(int)activeEventNumber,_sfTime_,(bool)isFasterRuntimeOn)
